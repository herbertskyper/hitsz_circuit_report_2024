...
HD_PWD='C:/Users/lenovo/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vr2to4dec_s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vr2to4dec_s.tcl -notrace
