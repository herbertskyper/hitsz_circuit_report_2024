...
HD_PWD='C:/Users/lenovo/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vr2to4dec_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vr2to4dec_s.tcl
