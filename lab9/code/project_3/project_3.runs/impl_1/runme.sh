...
HD_PWD='C:/Users/lenovo/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_reset.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dff_reset.tcl -notrace
