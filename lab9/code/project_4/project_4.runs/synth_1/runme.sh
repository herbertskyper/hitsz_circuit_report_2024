...
HD_PWD='C:/Users/lenovo/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_reset.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dff_reset.tcl
