...
HD_PWD='C:/Users/lenovo/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Refree_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Refree_s.tcl
