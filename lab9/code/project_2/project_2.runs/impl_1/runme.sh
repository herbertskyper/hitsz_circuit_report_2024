...
HD_PWD='C:/Users/lenovo/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Refree_s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Refree_s.tcl -notrace
